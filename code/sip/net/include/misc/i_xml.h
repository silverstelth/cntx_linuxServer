...
public:
	...
	/** Get the child node pointer named childName and property. NULL if no node. 
	*/
	static xmlNodePtr getChildNodeOfIntProperty (xmlNodePtr parent, const char *childName, const char *property, int nVal);

	/** Get the child node pointer named childName and property. NULL if no node. 
	*/
	static xmlNodePtr getChildNodeOfStringProperty (xmlNodePtr parent, const char *childName, const char *property, const char *value);
