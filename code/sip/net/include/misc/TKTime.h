...
inline TKTime::TKTime( uint32 days, uint32 hours, uint32 minutes, uint32 seconds, uint32 milliseconds )
{
    Set( days, hours, minutes, seconds, milliseconds );
}

inline TKTime::TKTime( uint16 year, uint16 month, uint16 day, uint16 hour, uint16 minute, uint16 second )
{
...
inline TKTime& TKTime::Set( uint32 days, uint32 hours, uint32 minutes, uint32 seconds, uint32 milliseconds )
{
...
inline TKTime& TKTime::Set( uint16 year, uint16 month, uint16 day, uint16 hour, uint16 minute, uint16 second )
{
    SYSTEMTIME sys;
...
inline TKTime& TKTime::Set( uint32 milliseconds )
{
...
#endif // end of guard __TKTIME_H__
