...
#ifndef __SIPHTTPCLIENT_H__
#define __SIPHTTPCLIENT_H__

/*!
 * \file	SipHttpClient.h
...
<h2>How to use SipHttpClient</h2>
...
try {
    ...
    objHttpReq.AddHeader (_T ("Sip-Magic"), _T ("My Magic Header")) ;
...
public:
    // Returns the last error code. The error codes is defined in SipHttpClient.h
...
#include <winhttp.h>			// for the windows http functions
...
#include "SipException.h"		// for exception classes
...
enum HttpClientErrorCode
{
	...
	, HTTPCLIENT_ERR_WINHTTPQUERYHEADERS_FAILED			= 400	//!< ::WinHttpQueryHeaders failed.
	, HTTPCLIENT_ERR_WINHTTPREADDATA_FAILED				= 401	//!< ::WinHttpReadData failed.
	, HTTPCLIENT_ERR_WINHTTPOPEN_FAILED					= 402	//!< ::WinHttpOpen failed.
	, HTTPCLIENT_ERR_WINHTTPCONNECT_FAILED				= 403	//!< ::WinHttpConnect failed.
	, HTTPCLIENT_ERR_WINHTTPOPENREQUEST_FAILED			= 404	//!< ::WinHttpOpenRequest failed.
	, HTTPCLIENT_ERR_WINHTTPADDREQUESTHEADERS_FAILED	= 405	//!< ::WinHttpAddRequestHeaders failed.
	, HTTPCLIENT_ERR_WINHTTPSENDREQUEST_FAILED			= 406	//!< ::WinHttpSendRequest failed.
	, HTTPCLIENT_ERR_WINHTTPSENDREQUESTEX_FAILED		= 407	//!< ::WinHttpSendRequest failed.
	, HTTPCLIENT_ERR_WINHTTPWRITEDATA_FAILED			= 408	//!< ::WinHttpWriteData failed.
	, HTTPCLIENT_ERR_WINHTTPRECEIVERESPONSE_FAILED		= 409	//!< ::WinHttpReceiveResponse failed.
	, HTTPCLIENT_ERR_WINHTTPSETOPTION_FAILED			= 410	//!< ::WinHttpSetOption failed.
...
public:
	...
	static HINTERNET OpenInternet (LPCWSTR szUserAgent, DWORD dwAccessType = WINHTTP_ACCESS_TYPE_DEFAULT_PROXY, LPCWSTR szProxyName = NULL, LPCWSTR szProxyBypass = NULL, DWORD dwFlags = 0) throw (Exception &) ;
	...
	static HINTERNET OpenRequest (HINTERNET hConnection, LPCWSTR szMethod, LPCWSTR szObjectName, DWORD dwFlags = WINHTTP_FLAG_REFRESH, LPCWSTR szReferer = NULL, UINT CodePage = CP_ACP) throw (Exception &) ;
	...
	static void EndRequest (HINTERNET hRequest, BOOL bIgnoreTimeout = FALSE) throw (Exception &) ;
	static BOOL FileExists (LPCWSTR szFilePath) throw (Exception &) ;
	static HANDLE OpenFile (LPCWSTR szFilePath, BOOL bShareWrite = FALSE) throw (Exception &) ;
...
public:
	...
	DWORD GetUserData (DWORD nIdx) throw () ;
	...
	DWORD GetUserData (PCSZ szName, DWORD nIdx = 0) throw () ;

	void AddPointerDirectly(PSZ szName, PSZ szValue = NULL, DWORD dwFlag = 0, DWORD dwUserData = 0) throw (Exception &);
	void Add(PCSZ szName, PCSZ szValue = NULL, DWORD dwFlag = 0, DWORD dwUserData = 0) throw (Exception &);
	void Set(PCSZ szName, PCSZ szValue = NULL, DWORD dwFlag = 0, DWORD dwUserData = 0, DWORD nIdx = 0) throw (Exception &);
...
public:
	...
	/*! \brief	Correct the number of bytes of the current parameter */
	void CorrectCurrParamTotalByte(size_t cbSize) throw (Exception &);
	/*! \brief	Returns the number of bytes of the current parameter */
	size_t CurrParamTotalByte (void) const throw (Exception &) ;
	/*! \brief	Returns correctness of the number of bytes of the current parameter */
	BOOL IsCurrParamTotalByteCorrect (void) const throw (Exception &) ;
...
private:
	...
	void _StartNewEntry(PCSZ szCurrParam, size_t cbCurrParam, BOOL bIsCorrect = TRUE, BOOL bIsFile = FALSE, PCSZ szCurrFile = NULL) throw (Exception &) ;
...
public:
	...
	*/
	enum ParamAttr
	{
		...
		, ParamMedia		= 0x00000003		//!< The parameter is a media file parameter.
		, ParamEncodedName	= 0x00000004		//!< The parameter's name is a URL-Encoded string.
		...
		, ParamEncodedValue	= 0x00000008		//!< The parameter's value is a URL-Encoded string.
	...
	void AddParam (PCSZ szName, PCSZ szValue = NULL, DWORD dwParamAttr = ParamNormal, DWORD dwUserData = 0) throw (Exception &) ;
	/*! \brief	Sets a HTTP parameter at the specified position */
	void SetParam (PCSZ szName, PCSZ szValue = NULL, DWORD dwParamAttr = ParamNormal, DWORD dwUserData = 0, DWORD nIdx = 0) throw (Exception &) ;
	...
	/*! \brief	Sets parameters for the ::WinHttpOpen function */
	void SetInternet (PCSZ szUserAgent = NULL, DWORD dwAccessType = WINHTTP_ACCESS_TYPE_DEFAULT_PROXY, PCSZ szProxyName = NULL, PCSZ szProxyBypass = NULL, DWORD dwFlags = 0) throw (Exception &) ;
	/*! \brief	Sets the lpszAgent parameter for the ::WinHttpOpen function */
	void SetInternetUserAgent (PCSZ szUserAgent = NULL) throw (Exception &) ;
	/*! \brief	Returns the lpszAgent parameter for the ::WinHttpOpen function */
	PCSZ GetInternetUserAgent (void) throw () ;
	/*! \brief	Sets the dwAccessType parameter for the ::WinHttpOpen function */
	void SetInternetAccessType (DWORD dwAccessType = WINHTTP_ACCESS_TYPE_DEFAULT_PROXY) throw () ;
	/*! \brief	Returns the dwAccessType parameter for the ::WinHttpOpen function */
	DWORD GetInternetAccessType (void) throw () ;
	/*! \brief	Sets the lpszProxyName parameter for the ::WinHttpOpen function */
	void SetInternetProxyName (PCSZ szProxyName = NULL) throw (Exception &) ;
	/*! \brief	Returns the lpszProxyName parameter for the ::WinHttpOpen function */
	PCSZ GetInternetProxyName (void) throw () ;
	/*! \brief	Sets the lpszProxyBypass parameter for the ::WinHttpOpen function */
	void SetInternetProxyBypass (PCSZ szProxyBypass = NULL) throw (Exception &) ;
	/*! \brief	Returns the lpszProxyBypass parameter for the ::WinHttpOpen function */
	PCSZ GetInternetProxyBypass (void) throw () ;
	/*! \brief	Sets the dwFlags parameter for the ::WinHttpOpen function */
	void SetInternetFlags (DWORD dwFlags = 0) throw () ;
	/*! \brief	Returns the dwFlags parameter for the ::WinHttpOpen function */
	...
	/*! \brief	Returns a new HINTERNET handle which is returned by ::WinHttpOpen */
	...
	HINTERNET OpenRequest (HINTERNET hConnection, PCSZ szVerb, PCSZ szUrl, DWORD dwFlags = WINHTTP_FLAG_REFRESH, PCSZ szReferer = NULL) throw (Exception &) ;
...
public:
	...
	/*! \brief	Retrieves the resource specified by the szUrl using HTTP GET request */
	CHttpResponse * RequestGetEx (HINTERNET hInternet, HINTERNET hConnection, PCSZ szUrl, DWORD dwFlags = WINHTTP_FLAG_REFRESH, PCSZ szReferer = NULL, PCSZ szUsrName = NULL, PCSZ szUsrPwd = NULL) throw (Exception &) ;
	/*! \brief	Retrieves the resource specified by the szUrl using HTTP GET request */
	CHttpResponse * RequestGetEx (HINTERNET hInternet, PCSZ szUrl, DWORD dwFlags = WINHTTP_FLAG_REFRESH, PCSZ szReferer = NULL, PCSZ szUsrName = NULL, PCSZ szUsrPwd = NULL) throw (Exception &) ;
	/*! \brief	Retrieves the resource specified by the szUrl using HTTP GET request */
	CHttpResponse * RequestGetEx (PCSZ szUrl, DWORD dwFlags = WINHTTP_FLAG_REFRESH, PCSZ szReferer = NULL, PCSZ szUsrName = NULL, PCSZ szUsrPwd = NULL) throw (Exception &) ;
	...
	/*! \brief	Starts a new HTTP POST request */
	void BeginPostEx (HINTERNET hInternet, HINTERNET hConnection, PCSZ szUrl, DWORD dwFlags = WINHTTP_FLAG_REFRESH, PCSZ szReferer = NULL, PCSZ szUsrName = NULL, PCSZ szUsrPwd = NULL) throw (Exception &) ;
	/*! \brief	Starts a new HTTP POST request */
	void BeginPostEx (HINTERNET hInternet, PCSZ szUrl, DWORD dwFlags = WINHTTP_FLAG_REFRESH, PCSZ szReferer = NULL, PCSZ szUsrName = NULL, PCSZ szUsrPwd = NULL) throw (Exception &) ;
	/*! \brief	Starts a new HTTP POST request */
	void BeginPostEx (PCSZ szUrl, DWORD dwFlags = WINHTTP_FLAG_REFRESH, PCSZ szReferer = NULL, PCSZ szUsrName = NULL, PCSZ szUsrPwd = NULL) throw (Exception &) ;
	...
	/*! \brief	Starts a new HTTP UPLOAD request */
	void BeginUploadEx (HINTERNET hInternet, HINTERNET hConnection, PCSZ szUrl, DWORD dwFlags = WINHTTP_FLAG_REFRESH, PCSZ szReferer = NULL, PCSZ szUsrName = NULL, PCSZ szUsrPwd = NULL) throw (Exception &) ;
	/*! \brief	Starts a new HTTP UPLOAD request */
	void BeginUploadEx (HINTERNET hInternet, PCSZ szUrl, DWORD dwFlags = WINHTTP_FLAG_REFRESH, PCSZ szReferer = NULL, PCSZ szUsrName = NULL, PCSZ szUsrPwd = NULL) throw (Exception &) ;
	/*! \brief	Starts a new HTTP UPLOAD request */
	void BeginUploadEx (PCSZ szUrl, DWORD dwFlags = WINHTTP_FLAG_REFRESH, PCSZ szReferer = NULL, PCSZ szUsrName = NULL, PCSZ szUsrPwd = NULL) throw (Exception &) ;
	...
	CHttpResponse * Proceed(DWORD cbDesired, BOOL bMediaOk = FALSE) throw (Exception &) ;
	...
	/*! \brief	Retrieves the resource specified by the szUrl using HTTP POST request */
	CHttpResponse * RequestPostEx (HINTERNET hInternet, HINTERNET hConnection, PCSZ szUrl, DWORD dwFlags = WINHTTP_FLAG_REFRESH, PCSZ szReferer = NULL, PCSZ szUsrName = NULL, PCSZ szUsrPwd = NULL) throw (Exception &) ;
	/*! \brief	Retrieves the resource specified by the szUrl using HTTP POST request */
	CHttpResponse * RequestPostEx (HINTERNET hInternet, PCSZ szUrl, DWORD dwFlags = WINHTTP_FLAG_REFRESH, PCSZ szReferer = NULL, PCSZ szUsrName = NULL, PCSZ szUsrPwd = NULL) throw (Exception &) ;
	/*! \brief	Retrieves the resource specified by the szUrl using HTTP POST request */
	CHttpResponse * RequestPostEx (PCSZ szUrl, DWORD dwFlags = WINHTTP_FLAG_REFRESH, PCSZ szReferer = NULL, PCSZ szUsrName = NULL, PCSZ szUsrPwd = NULL) throw (Exception &) ;
	...
	/*! \brief	Retrieves the resource specified by the szUrl using HTTP UPLOAD request */
	CHttpResponse * RequestUploadEx (HINTERNET hInternet, HINTERNET hConnection, PCSZ szUrl, DWORD dwFlags = WINHTTP_FLAG_REFRESH, PCSZ szReferer = NULL, PCSZ szUsrName = NULL, PCSZ szUsrPwd = NULL) throw (Exception &) ;
	/*! \brief	Retrieves the resource specified by the szUrl using HTTP UPLOAD request */
	CHttpResponse * RequestUploadEx (HINTERNET hInternet, PCSZ szUrl, DWORD dwFlags = WINHTTP_FLAG_REFRESH, PCSZ szReferer = NULL, PCSZ szUsrName = NULL, PCSZ szUsrPwd = NULL) throw (Exception &) ;
	/*! \brief	Retrieves the resource specified by the szUrl using HTTP UPLOAD request */
	CHttpResponse * RequestUploadEx (PCSZ szUrl, DWORD dwFlags = WINHTTP_FLAG_REFRESH, PCSZ szReferer = NULL, PCSZ szUsrName = NULL, PCSZ szUsrPwd = NULL) throw (Exception &) ;
...
private:
	...
	void _StartPostContext (HINTERNET hInternet, HINTERNET hConnection, PCSZ szUrl, DWORD dwFlags = WINHTTP_FLAG_REFRESH, PCSZ szReferer = NULL, PCSZ szUsrName = NULL, PCSZ szUsrPwd = NULL) throw (Exception &) ;
	...
	void _StartUploadContext(HINTERNET hInternet, HINTERNET hConnection, PCSZ szUrl, DWORD dwFlags = WINHTTP_FLAG_REFRESH, PCSZ szReferer = NULL, PCSZ szUsrName = NULL, PCSZ szUsrPwd = NULL) throw (Exception &) ;
	void _QueryUploadStat (CHttpPostStat & objPostStat) throw () ;
	BOOL _CancelUploadContext (void) throw () ;
	CHttpResponse * _ProceedUploadContext(DWORD nDesired, BOOL bMediaOk = false) throw (Exception &) ;
...
#endif // end of guard __SIPHTTPCLIENT_H__
