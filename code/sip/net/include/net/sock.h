 ...
 * \date 2000
 */
struct ESocket : public SIPBASE::Exception
{
	/** Constructor
...
struct ESocketConnectionTimeout : public ESocket
{
	ESocketConnectionTimeout( CInetAddress addr ) : ESocket( "Connection to %s timeout", true, &addr ) {}
};
 ...
 * This class implements layer 0 of the SIP Network Engine.
 ...
 * \date 2000-2001
 */
class CSock : public SIPBASE::CRefCount
{
public:
	...
	bool				forceClosed() { return _ForceClosed; }
...
protected:
	...
	//SIPBASE::CSynchronized<bool>	_SyncConnected;
	volatile bool	_Connected;
	volatile bool	_ForceClosed;
...
//extern	SIPBASE::CVariable<bool>	UseAsync;
