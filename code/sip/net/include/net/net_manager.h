 ...
 *
 * $Id: net_manager.h,v 1.2 2010/02/18 08:38:47 KimSuRyon Exp $
 */
...
#pragma message(SIP_LOC_WRN "You are using a deprecated feature of SIP, consider rewriting your code with replacement feature")

#ifndef SIP_NET_MANAGER_H
#define SIP_NET_MANAGER_H
...
public:
	...
	static void	addServer (const std::string &serviceName, uint16 servicePort, SIPNET::TServiceId &sid, bool external = false);
	 ...
	 */
	static void	update (SIPBASE::TTime timeout = 0);
...
private:
	...
	static	SIPBASE::TTime _NextUpdateTime;
