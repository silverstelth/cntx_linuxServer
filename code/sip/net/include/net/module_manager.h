...
namespace SIPNET
{
	 ...
	 */
	class IModuleManager : public SIPBASE::CRefCount
	{
	public:
		 ...
		 *	with the Sip naming standard according to compilation mode 
		...
		*/
		 ...
		 *	If the application is a SIP service, then this method
...
//													const TModuleGatewayProxyPtr &foreignGateway,
	...
	typedef SIPBASE::CFactoryIndirect<IModuleFactory, std::string>	TLocalModuleFactoryRegistry;

	/** Class for pure SIP module library */
	class CSipModuleLibrary : public SIPBASE::ISipLibrary
	{
	public:
